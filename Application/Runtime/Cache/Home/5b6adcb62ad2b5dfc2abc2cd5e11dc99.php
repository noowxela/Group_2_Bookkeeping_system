...
<div class="am-center">
    ...
    <div style="position:fixed; bottom:0; width:100%; line-height:200%; background-color: #fff; z-index: -1;">
      <div class="am-text-center am-text-secondary am-text-sm">
        <a href="/Accounting-page/index.php?s=/Home/Login/regist">注册账号</a>
        &nbsp;|&nbsp;
  ...
  <div class="am-popup-inner">
    ...
    <div class="am-container" >
      <div class="am-text-center">
        <img src="/Accounting-page/Public/Home/i/logo.png" style="max-height: 200px;">
      </div>
      <fieldset>
      ...
      <fieldset>
        ...
        <div class="am-text-left">
          ...
          <img src="/Accounting-page/Public/Home/i/xxjz-wechat-min.png" alt="小歆记账 for 微信小程序">
          <p style="text-indent:25px">
          ...
          am-avg-md-3 am-avg-lg-4 am-gallery-bordered" data-am-gallery="{ pureview: true }" >
              <li>
                <div class="am-gallery-item">
                  <img src="/Accounting-page/Public/Home/i/wechat.png"  alt="微信捐赠"/>
                  <div class="am-text-center am-text-success"><strong>微信捐赠</strong></div>
                </div>
              </li>
              <li>
                <div class="am-gallery-item">
                  <img src="/Accounting-page/Public/Home/i/alipay.png"  alt="支付宝捐赠"/>
    ...
    <div class="am-container" >
      ...
      <fieldset>
        ...
        <figure data-am-widget="figure" class="am am-figure am-figure-default "   data-am-figure="{  pureview: 'false' }">
          <img src="/Accounting-page/Public/Home/i/xxjz-wechat-min.png" data-rel="/Accounting-page/Public/Home/i/xxjz-wechat.png" alt="小歆记账 for 微信小程序"/>
        </figure>
