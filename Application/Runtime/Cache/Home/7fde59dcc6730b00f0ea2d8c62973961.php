...
$(function(){
    ...
    <script src="/Accounting-page/Public/Home/js/sortable.min.js"></script>
    <script type="text/javascript">
        ...
        function SaveSort(order, type) {
            try {
                FormPost("/Accounting-page/index.php?s=/Home/Class/sort", {'data': JSON.stringify(order).replace(/"/g, ''), 'type': type});
            }catch(e){
                console.log(e);
