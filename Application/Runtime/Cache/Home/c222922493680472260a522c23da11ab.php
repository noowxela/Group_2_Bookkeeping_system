...
<ul class="am-pagination am-pagination-centered" >
    <li class="am-pagination-prev"><a href="/Evo/xxjzWeb-master/index.php?s=/Home/Chart/index/year/<?php echo ($y-1); ?>">&laquo; <?php echo ($y-1); ?>年</a></li>
    <li class=""><a href="/Evo/xxjzWeb-master/index.php?s=/Home/Chart/index">今年</a></li>
    <li class="am-pagination-next"><a href="/Evo/xxjzWeb-master/index.php?s=/Home/Chart/index/year/<?php echo ($y+1); ?>"><?php echo ($y+1); ?>年 &raquo;</a></li>
</ul>
