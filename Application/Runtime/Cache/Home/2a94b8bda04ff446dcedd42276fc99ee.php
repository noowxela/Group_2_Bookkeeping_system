...
<?php if($PageMax > 1): ?><ul data-am-widget="pagination" class="am-pagination am-pagination-select">
        ...
        <li class="am-pagination-select">
            <select id="pid" onchange="SelectChange()" style="-webkit-appearance: button;">
                <?php $__FOR_START_1706629261__=1;$__FOR_END_1706629261__=$PageMax + 1;for($i=$__FOR_START_1706629261__;$i < $__FOR_END_1706629261__;$i+=1){ if($i == $Page ): ?><option value="/Evo/xxjzWeb-master/index.php?s=/Home/Index/index/p/<?php echo ($i); ?>#money-table" selected="selected">&nbsp;<?php echo ($i); ?></option>
                    <?php else: ?> 
